...
class SpeechBrainService:
    ...
    def __init__(self) -> None:
        ...
        self._verifier: SpeakerRecognition | None = None
    ...
    def _ensure_loaded(self) -> SpeakerRecognition:
        with self._lock:
    ...
    def extract_embedding(self, pcm: bytes) -> torch.Tensor:
    ...
    def _pcm_to_waveform_tensor(self, pcm: bytes) -> torch.Tensor:
